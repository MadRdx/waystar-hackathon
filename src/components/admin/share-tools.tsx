  ...
  return (
    <section className="relative overflow-hidden rounded-[2.5rem] border border-white/60 bg-gradient-to-br from-white/95 to-white/60 p-8 shadow-[0_8px_40px_rgb(0,0,0,0.04)] backdrop-blur-xl">
      ...
      <div className="relative z-10 mt-10 grid gap-6 lg:grid-cols-3">
        {/* URL Card */}
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-[2rem] border border-slate-200/60 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-brand/5">
          <div>
          ...
          <button
            ...
            className="mt-6 w-full rounded-2xl bg-slate-900 py-3.5 text-sm font-bold text-white transition-all hover:bg-slate-800 active:scale-[0.98] shadow-md hover:shadow-lg"
          >
            Copy Link
          </button>
        </div>
        ...
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-[2rem] border border-slate-200/60 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-brand/5">
            ...
            {previewSrc ? (
              <div className="mt-5 flex justify-center rounded-2xl bg-slate-50 py-3 border border-slate-100">
                ...
                <img
                  ...
                  className="h-28 w-28 rounded-xl bg-white p-2 shadow-sm mix-blend-multiply"
                />
              </div>
            ) : null}
          </div>
          <div className="mt-6 flex gap-3">
            <button
              type="button"
              onClick={downloadPng}
              className="flex-1 rounded-2xl bg-brand py-3.5 text-sm font-bold text-white transition-all hover:bg-brand-strong active:scale-[0.98] shadow-md hover:shadow-lg"
            >
              PNG
            </button>
            <button
